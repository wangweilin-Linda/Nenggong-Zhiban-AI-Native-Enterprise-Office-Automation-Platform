...
for col in result["numeric_columns"]:
    try:
        ...
        ax1.text(0.5, 0.95, '【直方图】', transform=ax1.transAxes, 
                 ...
                 bbox=dict(facecolor='#FFD700', alpha=0.8, boxstyle='round,pad=0.5', edgecolor='black', linewidth=2))
        ...
        if len(df) <= 1000:
            ...
            ax3.text(0.5, 0.95, '【散点图】', transform=ax3.transAxes, 
                     fontsize=16, fontweight='bold', ha='center',
                     bbox=dict(facecolor='#FFD700', alpha=0.8, boxstyle='round,pad=0.5', edgecolor='black', linewidth=2))
        ...
        ax4.text(0.5, 0.95, '【趋势图】', transform=ax4.transAxes, 
                 fontsize=16, fontweight='bold', ha='center',
                 bbox=dict(facecolor='#FFD700', alpha=0.8, boxstyle='round,pad=0.5', edgecolor='black', linewidth=2))
